...
export const Modal = Module.extend({
  ...
  initModal() {
    ...
    this.iframe = this.find('.hutko-modal-iframe')
    ...
    this.addEvent(this.find('.hutko-modal-close'), 'click', 'closeModal')
    this.addEvent(this.find('.hutko-modal-title a'), 'click', 'submitForm')
    this.initScrollbar()
